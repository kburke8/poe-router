...
const THE_CAGED_BRUTE: QuestGemTable = {
  ...
  vendorRewards: {
    Witch: ['Added Cold Damage Support', 'Added Lightning Damage Support', 'Blastchain Mine Support', 'Bodyswap', 'Clarity', 'Combustion Support', 'Devour Support', 'Efficacy Support', 'Flame Dash', 'Increased Critical Strikes Support', 'Infernal Legion Support', 'Lesser Multiple Projectiles Support', 'Lightning Warp', 'Locus Mine Support', 'Melee Splash Support', 'Minion Damage Support', 'Multiple Traps Support', 'Precision', 'Siphoning Trap', 'Smoke Mine', 'Spell Totem Support', 'Summon Skeletons', 'Trap Support', 'Unbound Ailments Support', 'Unearth', 'Vitality', 'Void Manipulation Support', 'Wither', 'Withering Step'],
    Shadow: ['Added Cold Damage Support', 'Added Fire Damage Support', 'Added Lightning Damage Support', 'Additional Accuracy Support', 'Arrow Nova Support', 'Ballista Totem Support', 'Blastchain Mine Support', 'Blind Support', 'Blink Arrow', 'Bodyswap', 'Chance to Flee Support', 'Clarity', 'Combustion Support', 'Devour Support', 'Efficacy Support', 'Faster Attacks Support', 'Flame Dash', 'Flicker Strike', 'Increased Critical Strikes Support', 'Lesser Multiple Projectiles Support', 'Lightning Warp', 'Locus Mine Support', 'Manaforged Arrows Support', 'Melee Splash Support', 'Multiple Traps Support', 'Precision', 'Siphoning Trap', 'Smoke Mine', 'Trap Support', 'Unbound Ailments Support', 'Unearth', 'Vitality', 'Void Manipulation Support', 'Whirling Blades', 'Wither', 'Withering Step'],
    Ranger: ['Added Cold Damage Support', 'Added Fire Damage Support', 'Additional Accuracy Support', 'Arrow Nova Support', 'Ballista Totem Support', 'Blastchain Mine Support', 'Blind Support', 'Blink Arrow', 'Bodyswap', 'Chance to Flee Support', 'Clarity', 'Faster Attacks Support', 'Flicker Strike', 'Increased Critical Strikes Support', 'Leap Slam', 'Lesser Multiple Projectiles Support', 'Locus Mine Support', 'Maim Support', 'Manaforged Arrows Support', 'Melee Splash Support', 'Multiple Traps Support', 'Precision', 'Smoke Mine', 'Trap Support', 'Unearth', 'Vitality', 'Void Manipulation Support', 'Whirling Blades', 'Withering Step'],
    Duelist: ['Added Fire Damage Support', 'Additional Accuracy Support', 'Arrow Nova Support', 'Ballista Totem Support', 'Blind Support', 'Blink Arrow', 'Chance to Flee Support', 'Clarity', 'Enduring Cry', 'Faster Attacks Support', 'Flicker Strike', 'Intimidating Cry', 'Knockback Support', 'Leap Slam', 'Lesser Multiple Projectiles Support', 'Life Gain on Hit Support', 'Lifetap Support', 'Maim Support', 'Melee Splash Support', 'Precision', 'Smoke Mine', 'Stun Support', 'Trap Support', 'Vitality', 'Whirling Blades', 'Withering Step'],
    Marauder: ['Added Fire Damage Support', 'Additional Accuracy Support', 'Blind Support', 'Chance to Flee Support', 'Clarity', 'Combustion Support', 'Enduring Cry', 'Faster Attacks Support', 'Flamewood Support', 'Flicker Strike', 'Intimidating Cry', 'Knockback Support', 'Leap Slam', 'Life Gain on Hit Support', 'Lifetap Support', 'Maim Support', 'Melee Splash Support', 'Precision', 'Smoke Mine', 'Spell Totem Support', 'Stun Support', 'Vitality'],
    Templar: ['Added Fire Damage Support', 'Added Lightning Damage Support', 'Additional Accuracy Support', 'Blastchain Mine Support', 'Bodyswap', 'Clarity', 'Combustion Support', 'Devour Support', 'Efficacy Support', 'Enduring Cry', 'Flame Dash', 'Flamewood Support', 'Infernal Legion Support', 'Intimidating Cry', 'Knockback Support', 'Leap Slam', 'Life Gain on Hit Support', 'Lifetap Support', 'Lightning Warp', 'Melee Splash Support', 'Minion Damage Support', 'Precision', 'Spell Totem Support', 'Stun Support', 'Summon Skeletons', 'Unbound Ailments Support', 'Unearth', 'Vitality', 'Void Manipulation Support', 'Wither'],
    Scion: ['Added Cold Damage Support', 'Added Fire Damage Support', 'Added Lightning Damage Support', 'Additional Accuracy Support', 'Arrow Nova Support', 'Ballista Totem Support', 'Blastchain Mine Support', 'Blind Support', 'Blink Arrow', 'Bodyswap', 'Chance to Flee Support', 'Clarity', 'Devour Support', 'Efficacy Support', 'Enduring Cry', 'Faster Attacks Support', 'Flame Dash', 'Flamewood Support', 'Flicker Strike', 'Increased Critical Strikes Support', 'Intimidating Cry', 'Knockback Support', 'Leap Slam', 'Lesser Multiple Projectiles Support', 'Life Gain on Hit Support', 'Lifetap Support', 'Lightning Warp', 'Locus Mine Support', 'Maim Support', 'Manaforged Arrows Support', 'Melee Splash Support', 'Minion Damage Support', 'Multiple Traps Support', 'Precision', 'Siphoning Trap', 'Spell Totem Support', 'Stun Support', 'Summon Skeletons', 'Trap Support', 'Unbound Ailments Support', 'Unearth', 'Vitality', 'Void Manipulation Support', 'Wither', 'Withering Step'],
  },
};

// Nessa's reward: support gems

...
const MERCY_MISSION: QuestGemTable = {
  ...
  vendorRewards: {
    Witch: ['Elemental Proliferation Support', 'Hallow Support', 'Infused Channelling Support', 'Spell Cascade Support', 'Summon Phantasm Support', 'Swift Assembly Support', 'Volley Support'],
    ...
    Duelist: ['Ancestral Call Support', 'Chance to Poison Support', 'Mirage Archer Support', 'Momentum Support', 'Pierce Support', 'Ruthless Support', 'Swift Assembly Support', 'Volley Support'],
...
const THE_CAGED_BRUTE_NESSA: QuestGemTable = {
  ...
  questRewards: {
    ...
    Shadow: ['Added Cold Damage Support', 'Added Lightning Damage Support', 'Faster Attacks Support', 'Multiple Projectiles Support', 'Multiple Traps Support', 'Void Manipulation Support'],
    Ranger: ['Added Cold Damage Support', 'Arrow Nova Support', 'Faster Attacks Support', 'Manaforged Arrows Support', 'Melee Splash Support', 'Multiple Projectiles Support', 'Void Manipulation Support'],
    Duelist: ['Added Fire Damage Support', 'Faster Attacks Support', 'Lifetap Support', 'Maim Support', 'Melee Splash Support', 'Multiple Projectiles Support'],
    ...
    Scion: ['Added Cold Damage Support', 'Added Fire Damage Support', 'Added Lightning Damage Support', 'Faster Attacks Support', 'Lifetap Support', 'Melee Splash Support', 'Multiple Projectiles Support', 'Unbound Ailments Support'],
  },
  // Support gems available from Nessa's vendor after The Caged Brute
  vendorRewards: {
    Witch: ['Added Cold Damage Support', 'Added Lightning Damage Support', 'Blastchain Mine Support', 'Combustion Support', 'Devour Support', 'Efficacy Support', 'Increased Critical Strikes Support', 'Infernal Legion Support', 'Locus Mine Support', 'Melee Splash Support', 'Minion Damage Support', 'Multiple Projectiles Support', 'Multiple Traps Support', 'Spell Totem Support', 'Trap Support', 'Unbound Ailments Support', 'Void Manipulation Support'],
    Shadow: ['Added Cold Damage Support', 'Added Fire Damage Support', 'Added Lightning Damage Support', 'Additional Accuracy Support', 'Arrow Nova Support', 'Ballista Totem Support', 'Blastchain Mine Support', 'Blind Support', 'Chance to Flee Support', 'Combustion Support', 'Devour Support', 'Efficacy Support', 'Faster Attacks Support', 'Increased Critical Strikes Support', 'Locus Mine Support', 'Manaforged Arrows Support', 'Melee Splash Support', 'Multiple Projectiles Support', 'Multiple Traps Support', 'Trap Support', 'Unbound Ailments Support', 'Void Manipulation Support'],
    Ranger: ['Added Cold Damage Support', 'Added Fire Damage Support', 'Additional Accuracy Support', 'Arrow Nova Support', 'Ballista Totem Support', 'Blastchain Mine Support', 'Blind Support', 'Chance to Flee Support', 'Faster Attacks Support', 'Increased Critical Strikes Support', 'Locus Mine Support', 'Maim Support', 'Manaforged Arrows Support', 'Melee Splash Support', 'Multiple Projectiles Support', 'Multiple Traps Support', 'Trap Support', 'Void Manipulation Support'],
    Duelist: ['Added Fire Damage Support', 'Additional Accuracy Support', 'Arrow Nova Support', 'Ballista Totem Support', 'Blind Support', 'Chance to Flee Support', 'Faster Attacks Support', 'Knockback Support', 'Life Gain on Hit Support', 'Lifetap Support', 'Maim Support', 'Melee Splash Support', 'Multiple Projectiles Support', 'Stun Support', 'Trap Support'],
    ...
    Scion: ['Added Cold Damage Support', 'Added Fire Damage Support', 'Added Lightning Damage Support', 'Additional Accuracy Support', 'Arrow Nova Support', 'Ballista Totem Support', 'Blastchain Mine Support', 'Blind Support', 'Chance to Flee Support', 'Devour Support', 'Efficacy Support', 'Faster Attacks Support', 'Flamewood Support', 'Increased Critical Strikes Support', 'Knockback Support', 'Life Gain on Hit Support', 'Lifetap Support', 'Locus Mine Support', 'Maim Support', 'Manaforged Arrows Support', 'Melee Splash Support', 'Minion Damage Support', 'Multiple Projectiles Support', 'Multiple Traps Support', 'Spell Totem Support', 'Stun Support', 'Trap Support', 'Unbound Ailments Support', 'Void Manipulation Support'],
  },
};
...
const THE_SIRENS_CADENCE: QuestGemTable = {
  ...
  questRewards: {
    ...
    Duelist: ['Earthshatter', 'Holy Sweep', 'Lacerate', 'Rain of Arrows', 'Shattering Steel', 'Volcanic Fissure'],
    Marauder: ['Chain Hook', 'Earthshatter', 'Holy Sweep', 'Infernal Blow', 'Static Strike', 'Sunder', 'Volcanic Fissure'],
  ...
  vendorRewards: {
    ...
    Shadow: ['Arc', 'Barrage', 'Blade Vortex', 'Blazing Salvo', 'Creeping Frost', 'Elemental Hit', 'Essence Drain', 'Exsanguinate', 'Fire Trap', 'Flame Surge', 'Ice Nova', 'Ice Spear', 'Icicle Mine', 'Incinerate', 'Kinetic Fusillade', 'Lacerate', 'Lightning Arrow', 'Lightning Strike', 'Lightning Trap', 'Manabond', 'Poisonous Concoction', 'Power Siphon', 'Rain of Arrows', 'Reave', 'Scorching Ray', 'Siege Ballista', 'Spectral Helix', 'Storm Burst', 'Storm Call', 'Toxic Rain', 'Venom Gyre', 'Volatile Dead', 'Voltaxic Burst', 'Wintertide Brand'],
    Ranger: ['Barrage', 'Blade Vortex', 'Elemental Hit', 'Fire Trap', 'Infernal Blow', 'Lacerate', 'Lightning Arrow', 'Lightning Strike', 'Lightning Trap', 'Poisonous Concoction', 'Rain of Arrows', 'Reave', 'Shattering Steel', 'Siege Ballista', 'Spectral Helix', 'Static Strike', 'Toxic Rain', 'Venom Gyre', 'Volatile Dead'],
    Duelist: ['Barrage', 'Chain Hook', 'Earthshatter', 'Elemental Hit', 'Holy Sweep', 'Infernal Blow', 'Lacerate', 'Lightning Arrow', 'Lightning Strike', 'Poisonous Concoction', 'Rain of Arrows', 'Reave', 'Shattering Steel', 'Siege Ballista', 'Spectral Helix', 'Static Strike', 'Sunder', 'Toxic Rain'],
    Marauder: ['Absolution', 'Chain Hook', 'Earthshatter', 'Exsanguinate', 'Holy Sweep', 'Infernal Blow', 'Lacerate', 'Searing Bond', 'Spectral Helix', 'Static Strike', 'Sunder'],
    Templar: ['Absolution', 'Arc', 'Blazing Salvo', 'Bone Offering', 'Creeping Frost', 'Earthshatter', 'Essence Drain', 'Exsanguinate', 'Flame Surge', 'Flesh Offering', 'Holy Sweep', 'Ice Nova', 'Ice Spear', 'Icicle Mine', 'Incinerate', 'Infernal Blow', 'Lacerate', 'Lightning Strike', 'Manabond', 'Scorching Ray', 'Searing Bond', 'Spectral Helix', 'Spirit Offering', 'Static Strike', 'Storm Brand', 'Storm Burst', 'Storm Call', 'Sunder', 'Volatile Dead', 'Wintertide Brand'],
    Scion: ['Absolution', 'Barrage', 'Blade Vortex', 'Blazing Salvo', 'Bone Offering', 'Chain Hook', 'Creeping Frost', 'Earthshatter', 'Elemental Hit', 'Essence Drain', 'Exsanguinate', 'Fire Trap', 'Flame Surge', 'Flesh Offering', 'Holy Sweep', 'Ice Nova', 'Ice Spear', 'Icicle Mine', 'Incinerate', 'Infernal Blow', 'Kinetic Fusillade', 'Lacerate', 'Lightning Strike', 'Lightning Trap', 'Manabond', 'Poisonous Concoction', 'Power Siphon', 'Rain of Arrows', 'Scorching Ray', 'Shattering Steel', 'Siege Ballista', 'Spectral Helix', 'Spirit Offering', 'Static Strike', 'Storm Brand', 'Storm Burst', 'Storm Call', 'Sunder', 'Toxic Rain', 'Venom Gyre', 'Volatile Dead', 'Voltaxic Burst', 'Wintertide Brand'],
  },
};
...
const INTRUDERS_IN_BLACK: QuestGemTable = {
  ...
  questRewards: {
    ...
    Templar: ['Arcane Cloak', 'Brand Recall', 'Divine Retribution', 'Herald of Ash', 'Herald of Ice', 'Herald of Purity', 'Herald of Thunder', 'Shield of Light', 'Wave of Conviction'],
  ...
  vendorRewards: {
    ...
    Templar: ['Ancestral Cry', 'Arcane Cloak', 'Arctic Armour', 'Blade Blast', 'Brand Recall', 'Cold Snap', 'Corrupting Fever', 'Defiance Banner', 'Desecrate', 'Divine Retribution', 'Eviscerate', 'Galvanic Field', 'Herald of Ash', 'Herald of Ice', 'Herald of Purity', 'Herald of Thunder', 'Molten Shell', 'Righteous Fire', 'Seismic Cry', 'Shield of Light', 'Tempest Shield', 'Wave of Conviction'],
    Scion: ['Ancestral Cry', 'Arcane Cloak', 'Arctic Armour', "Assassin's Mark", 'Blade Blast', 'Blood Rage', 'Brand Recall', 'Cold Snap', 'Corrupting Fever', 'Defiance Banner', 'Desecrate', 'Divine Retribution', 'Ensnaring Arrow', 'Eviscerate', 'Flesh and Stone', 'Forbidden Rite', 'Frenzy', 'Glacial Shield Swipe', 'Herald of Agony', 'Herald of Ash', 'Herald of Ice', 'Herald of Purity', 'Herald of Thunder', 'Molten Shell', "Poacher's Mark", 'Righteous Fire', 'Seismic Cry', 'Shield of Light', 'Summon Skitterbots', 'Swordstorm', 'Tempest Shield', 'Wall of Force', "Warlord's Mark", 'Wave of Conviction'],
  },
};
...
const SHARP_AND_CRUEL: QuestGemTable = {
  ...
  questRewards: {
    ...
    Templar: [
      ...
      'Exemplar Support', 'Faster Casting Support', 'Melee Physical Damage Support', 'Shockwave Support',
    ],
    Scion: [
...
const A_FIXTURE_OF_FATE: QuestGemTable = {
  ...
  questRewards: {
    Witch: [
      'Archmage Support', 'Blasphemy Support', 'Burning Damage Support',
      'Cold Penetration Support', 'Energy Leech Support', 'Feeding Frenzy Support',
      'Fire Penetration Support', 'Focused Channelling Support', 'Impending Doom Support',
      'Intensify Support', 'Lightning Penetration Support', 'Meat Shield Support',
      'Pinpoint Support', 'Sacrifice Support', 'Swift Affliction Support',
    ],
    Shadow: [
      'Archmage Support', 'Charged Mines Support', 'Charged Traps Support',
      'Cold Penetration Support', 'Critical Strike Affliction Support', 'Energy Leech Support',
      'Faster Projectiles Support', 'Focused Channelling Support', 'High-Impact Mine Support',
      'Ice Bite Support', 'Impending Doom Support', 'Innervate Support',
      'Lightning Penetration Support', 'Pinpoint Support', 'Second Wind Support',
      'Swift Affliction Support',
    ],
    Ranger: [
      'Critical Strike Affliction Support', 'Focused Ballista Support', 'Fortify Support',
      'Hypothermia Support', 'Ice Bite Support', 'Impale Support',
      'Life Leech Support', 'Second Wind Support', 'Windburst Support',
    ],
    Duelist: [
      'Arrogance Support', 'Bloodthirst Support', 'Expert Retaliation Support',
      'Fortify Support', 'Hypothermia Support', 'Impale Support',
      'Life Leech Support', 'Pulverise Support', 'Urgent Orders Support',
    ],
    Marauder: [
      'Arrogance Support', 'Bloodthirst Support', 'Controlled Blaze Support',
      'Corrupting Cry Support', 'Fortify Support', 'Impale Support',
      'Life Leech Support', 'Pulverise Support', 'Urgent Orders Support',
    ],
    Templar: [
      'Archmage Support', 'Arrogance Support', 'Blasphemy Support',
      'Blessed Call Support', 'Burning Damage Support', 'Cold Penetration Support',
      'Divine Blessing Support', 'Energy Leech Support', 'Excommunicate Support',
      'Fire Penetration Support', 'Fortify Support', 'Intensify Support',
      'Lightning Penetration Support', 'Pulverise Support', 'Swiftbrand Support',
    ],
    Scion: [],
  },
  vendorRewards: {
    Witch: ['Cursed Ground Support', 'Focused Channelling Support', 'Sacrifice Support'],
    Shadow: ['Cursed Ground Support', 'Focused Channelling Support', 'Sacrifice Support', 'Windburst Support'],
    Ranger: ['Windburst Support'],
    Duelist: ['Windburst Support'],
    Marauder: ['Blessed Call Support', 'Corrupting Cry Support', 'Excommunicate Support', 'Expert Retaliation Support'],
    Templar: ['Blessed Call Support', 'Corrupting Cry Support', 'Excommunicate Support', 'Expert Retaliation Support', 'Focused Channelling Support'],
    Scion: ['Blessed Call Support', 'Corrupting Cry Support', 'Excommunicate Support', 'Expert Retaliation Support', 'Focused Channelling Support', 'Windburst Support'],
  },
};
...
const SEVER_THE_RIGHT_HAND: QuestGemTable = {
  ...
  questRewards: {
    ...
    Templar: [
      'Armageddon Brand', 'Consecrated Path', 'Divine Blast', 'Divine Ire', 'Dominating Blow',
      'Firestorm', 'Flameblast', 'Holy Hammers', 'Ice Crash', 'Penance Brand',
  ...
  vendorRewards: {
    Witch: ['Animate Guardian', 'Armageddon Brand', 'Ball Lightning', 'Bladefall', 'Crackling Lance', 'Cremation', 'Dark Bargain', 'Discharge', 'Divine Ire', 'Eye of Winter', 'Firestorm', 'Flameblast', 'Flamethrower Trap', 'Glacial Cascade', 'Hexblast', 'Ice Trap', 'Kinetic Blast', 'Kinetic Rain', 'Lightning Conduit', 'Lightning Spire Trap', 'Penance Brand', 'Pyroclast Mine', 'Raise Spectre', 'Reap', 'Seismic Trap', 'Shock Nova', 'Shockwave Totem', 'Somatic Shell', 'Soulrend', 'Stormbind', 'Summon Reaper', 'Vortex', 'Winter Orb'],
    Shadow: ['Animate Guardian', 'Artillery Ballista', 'Ball Lightning', 'Blade Flurry', 'Bladefall', 'Charged Dash', 'Crackling Lance', 'Cremation', 'Dark Bargain', 'Discharge', 'Divine Ire', 'Explosive Concoction', 'Eye of Winter', 'Firestorm', 'Flameblast', 'Flamethrower Trap', 'Glacial Cascade', 'Hexblast', 'Ice Crash', 'Ice Trap', 'Kinetic Blast', 'Kinetic Rain', 'Lightning Conduit', 'Lightning Spire Trap', 'Pestilent Strike', 'Pyroclast Mine', 'Reap', 'Scourge Arrow', 'Seismic Trap', 'Shock Nova', 'Somatic Shell', 'Soulrend', 'Storm Rain', 'Stormbind', 'Thunderstorm', 'Tornado Shot', 'Vortex', 'Wild Strike', 'Winter Orb'],
    ...
    Marauder: ['Animate Guardian', 'Artillery Ballista', 'Bladestorm', 'Boneshatter', 'Charged Dash', 'Consecrated Path', 'Cyclone', 'Discharge', 'Divine Blast', 'Dominating Blow', 'Earthquake', 'Explosive Arrow', 'Flameblast', 'Ice Crash', 'Rage Vortex', 'Reap', 'Shockwave Totem', 'Spectral Shield Throw', 'Tectonic Slam'],
    Templar: ['Animate Guardian', 'Armageddon Brand', 'Ball Lightning', 'Boneshatter', 'Charged Dash', 'Consecrated Path', 'Crackling Lance', 'Cremation', 'Cyclone', 'Discharge', 'Divine Blast', 'Divine Ire', 'Dominating Blow', 'Earthquake', 'Eye of Winter', 'Firestorm', 'Flameblast', 'Glacial Cascade', 'Hexblast', 'Holy Hammers', 'Ice Crash', 'Kinetic Blast', 'Kinetic Rain', 'Lightning Conduit', 'Penance Brand', 'Pyroclast Mine', 'Rage Vortex', 'Raise Spectre', 'Reap', 'Shock Nova', 'Shockwave Totem', 'Somatic Shell', 'Soulrend', 'Spectral Shield Throw', 'Stormbind', 'Summon Reaper', 'Tectonic Slam', 'Vortex', 'Winter Orb'],
    Scion: ['Animate Guardian', 'Armageddon Brand', 'Artillery Ballista', 'Blade Flurry', 'Bladefall', 'Bladestorm', 'Blast Rain', 'Boneshatter', 'Charged Dash', 'Consecrated Path', 'Crackling Lance', 'Cremation', 'Cyclone', 'Dark Bargain', 'Discharge', 'Divine Blast', 'Divine Ire', 'Dominating Blow', 'Earthquake', 'Explosive Concoction', 'Eye of Winter', 'Firestorm', 'Flameblast', 'Flamethrower Trap', 'Glacial Cascade', 'Hexblast', 'Ice Crash', 'Ice Trap', 'Kinetic Blast', 'Kinetic Rain', 'Lancing Steel', 'Lightning Spire Trap', 'Penance Brand', 'Pestilent Strike', 'Pyroclast Mine', 'Rage Vortex', 'Raise Spectre', 'Reap', 'Scourge Arrow', 'Seismic Trap', 'Shock Nova', 'Somatic Shell', 'Soulrend', 'Spectral Shield Throw', 'Storm Rain', 'Stormbind', 'Summon Reaper', 'Tectonic Slam', 'Thunderstorm', 'Tornado Shot', 'Vortex', 'Wild Strike', 'Winter Orb'],
  },
};

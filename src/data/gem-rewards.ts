...
const A_FIXTURE_OF_FATE: QuestGemTable = {
  ...
  vendorRewards: {
    ...
    Marauder: ['Blessed Call Support', 'Corrupting Cry Support', 'Expert Retaliation Support'],
...
const SEVER_THE_RIGHT_HAND: QuestGemTable = {
  ...
  vendorRewards: {
    ...
    Templar: ['Animate Guardian', 'Armageddon Brand', 'Ball Lightning', 'Boneshatter', 'Charged Dash', 'Consecrated Path', 'Crackling Lance', 'Cremation', 'Cyclone', 'Discharge', 'Divine Blast', 'Divine Ire', 'Dominating Blow', 'Earthquake', 'Eye of Winter', 'Firestorm', 'Flameblast', 'Glacial Cascade', 'Hexblast', 'Ice Crash', 'Kinetic Blast', 'Kinetic Rain', 'Lightning Conduit', 'Penance Brand', 'Pyroclast Mine', 'Rage Vortex', 'Raise Spectre', 'Reap', 'Shock Nova', 'Shockwave Totem', 'Somatic Shell', 'Soulrend', 'Spectral Shield Throw', 'Stormbind', 'Summon Reaper', 'Tectonic Slam', 'Vortex', 'Winter Orb'],
    Scion: ['Animate Guardian', 'Armageddon Brand', 'Artillery Ballista', 'Blade Flurry', 'Bladefall', 'Bladestorm', 'Blast Rain', 'Boneshatter', 'Charged Dash', 'Consecrated Path', 'Crackling Lance', 'Cremation', 'Cyclone', 'Dark Pact', 'Discharge', 'Divine Blast', 'Divine Ire', 'Dominating Blow', 'Earthquake', 'Explosive Concoction', 'Eye of Winter', 'Firestorm', 'Flameblast', 'Flamethrower Trap', 'Glacial Cascade', 'Hexblast', 'Ice Crash', 'Ice Trap', 'Kinetic Blast', 'Kinetic Rain', 'Lancing Steel', 'Lightning Spire Trap', 'Penance Brand', 'Pestilent Strike', 'Pyroclast Mine', 'Rage Vortex', 'Raise Spectre', 'Reap', 'Scourge Arrow', 'Seismic Trap', 'Shock Nova', 'Somatic Shell', 'Soulrend', 'Spectral Shield Throw', 'Storm Rain', 'Stormbind', 'Summon Reaper', 'Tectonic Slam', 'Thunderstorm', 'Tornado Shot', 'Vortex', 'Wild Strike', 'Winter Orb'],
  },
};
